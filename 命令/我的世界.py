...
#     f'-Dlog4j.configurationFile={基础目录}/versions/{版本}/log4j2.xml',
#     f'-Dminecraft.client.jar={基础目录}/versions/{版本}/{版本}.jar',
